...
{
      permeabilidade = (1.151 * reservatorio.SistemaUnidade() * poco.Vazao() * fluido.FatorVolumeFormacao() * 
      ...
      if (reservatorio.SistemaUnidade()==0.3183)
         cout << " metros quadrados" << endl; ///criacao do objeto armazena da classe CSimuladorAnaliseTestePressao
...
void CSimuladorAnaliseTestePressao::CalculoFatorPelicula ()
{
       fatorPelicula = 1.151 * ((((ajuste.m * log10(poco.TempoProducao())) + ajuste.n - poco.PressaoPoco())/ 
                       -ajuste.m) - log10((reservatorio.SistemaUnidade() * permeabilidade) / 
